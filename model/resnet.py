####################################
# ResNet code from PyTorch source code
####################################
...
class ResNet(nn.Module):
    def __init__(
        ...
        # Convert string block type to actual block class
        if block == "BasicBlock":
            block = BasicBlock
        elif block == "Bottleneck":
            block = Bottleneck
        else:
            raise ValueError(f"Block type {block} not supported. Use 'BasicBlock' or 'Bottleneck'")
